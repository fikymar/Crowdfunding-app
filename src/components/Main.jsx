            ...
            <div className="main_header">
               <div className="main_header--logo">{logomaster}</div>
                ...
                <div className='main_header--buttons'> 
                        <Button value={'Back this project'}  handleModal={handleModal}  />
                        
                        <button className={`main_header--bookmarkBTN ${bookmark ? 'bookmarked' : ''}`}
                            type='button'
                            onClick={() => setBookmark(!bookmark)} 
                          
                            
                        >{bookmarkIcon} <span>Bookmark</span></button>
                    </div>  
                </div>
